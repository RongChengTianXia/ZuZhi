...
import com.zuzhi.tianyou.base.IMBaseActivity;
import com.zuzhi.tianyou.im.Constant;
import com.zuzhi.tianyou.im.DemoHelper;
import com.zuzhi.tianyou.im.db.InviteMessgeDao;
import com.zuzhi.tianyou.im.db.UserDao;
import com.zuzhi.tianyou.im.domain.InviteMessage;
...
public class IMActivity extends IMBaseActivity implements View.OnClickListener, EMEventListener {
    ...
    /**
     * conversation list fragment 会话列表页
     */
    ...
    protected void initViews() {
        if (mSavedInstanceState != null && mSavedInstanceState.getBoolean(Constant.ACCOUNT_REMOVED, false)) {
            ...
            return;
        } else if (mSavedInstanceState != null && mSavedInstanceState.getBoolean("isConflict", false)) {
...
//
//        tv_title_bar_text.setText(R.string.message);
//
